...
You can [listen to the full album here](/music/a-whisper-of-ruin-deluxe/). But if you want to know where it came from — why it sounds the way it sounds, why it's sequenced the way it is, why certain songs almost didn't survive — that's what this is for.
